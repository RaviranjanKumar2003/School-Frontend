...
import com.example.stud_erp.payload.SubjectSessionDTO;
import com.example.stud_erp.repository.SemesterRepository;
import com.example.stud_erp.service.SubjectSessionService;
...
public class SubjectSessionController {
    ...
    @Autowired
    private SubjectSessionService subjectService;

    @Autowired
    private SemesterRepository semesterRepository;

    @PostMapping("/add")
    public ResponseEntity<SubjectSession> createSubject(@RequestBody SubjectSessionDTO dto) {
        ...
        SubjectSession savedSubject = subjectService.addSubject(subject);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SubjectSession> getSubjectById(@PathVariable Long id) {
        Optional<SubjectSession> subject = subjectService.getSubjectById(id);
