...
//       const teacherRes = await api.get("/teacher/all");
//       const studentRes = await api.get("/student/all");
//       const hodRes = await api.get("/hod/all");
//       const accountantRes = await api.get("/accountant/all");
...
//           Manage teachers, students, HODs, accountants and school operations.
//         </p>
...
//           <button className="bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-xl font-semibold transition">

//             Add Teacher

//           </button>

//           <button className="bg-green-600 hover:bg-green-700 text-white p-4 rounded-xl font-semibold transition">

//             Add Student

//           </button>

//           <button className="bg-purple-600 hover:bg-purple-700 text-white p-4 rounded-xl font-semibold transition">

//             Add HOD

//           </button>

//           <button className="bg-red-500 hover:bg-red-600 text-white p-4 rounded-xl font-semibold transition">
...
//               bg="bg-blue-100"
//               text="text-blue-700"
//               message="New teacher registrations available."
//             />

//             <Notification
//               bg="bg-green-100"
//               text="text-green-700"
//               message="Student admissions updated successfully."
//             />

//             <Notification
//               bg="bg-purple-100"
//               text="text-purple-700"
//               message="HOD department assignments updated."
//             />

//             <Notification
//               bg="bg-red-100"
//               text="text-red-700"
//               message="Accountant management access enabled."
//             />
...
//       <p className={`text-4xl font-bold mt-4 ${colorMap[color]}`}>
//         {value}
//       </p>
...
// function SummaryRow({ title, value, color }) {
...
// function Notification({ bg, text, message }) {
