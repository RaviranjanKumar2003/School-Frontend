...
function ProfileMenu({ openMenu, setOpenMenu }) {
  ...
  useEffect(() => {
    ...
    /* ================= PROFESSOR ================= */
      ...
      storedData = localStorage.getItem("professorData");
    }

    /* ================= HOD ================= */

    else if (userRole === "hod") {
      storedData = localStorage.getItem("hodData");
    }

    /* ================= SUPER ADMIN ================= */

    else if (userRole === "superadmin") {
      storedData = localStorage.getItem("adminData");
    }

    /* ================= SCHOOL ADMIN ================= */

    else if (userRole === "schooladmin") {
      storedData = localStorage.getItem("schoolAdminData");
    }

    /* ================= ACCOUNTANT ================= */

    else if (userRole === "accountant") {
      storedData = localStorage.getItem("accountant");
    }
  ...
  const displayName =
    ...
    `${user?.studName || ""} ${user?.studLastName || ""}`.trim() ||
    "User";
      ...
      >
        ...
        <MenuItem className="p-0 mt-2">
          <Link
            to={
              userRole === "accountant"
                ? "/dashboard/accountant/profile"
                : `/dashboard/${userRole}/information`
            }
            className="
              flex items-center gap-3
              px-3 py-2
